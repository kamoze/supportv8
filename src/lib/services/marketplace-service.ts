...
export const INITIAL_PLANS: MarketplacePlan[] = [
  {
    ...
    computeUnits: "250,000 Tokens / mo",
    aiEmployeeSeats: 4,
  },
  {
    id: "plan_scale",
    ...
    isCurrent: true,
    features: [
      "Up to 15,000 tickets / month",
      "5 AI Employee Seats + Unlimited Interns",
      "All Connectors + Twilio Voice Telephony",
      "Pro SLA (1hr First Response / 8hr Resolution)",
      "Autonomous Resolution Mode (VARR)",
      "Real-Time Problem Correlation Matrix",
      "KnowledgeV8 Unlimited RAG Embeddings",
    ],
    slaCommitment: "99.8% SLA Attainment",
    computeUnits: "1,500,000 Tokens / mo",
    aiEmployeeSeats: 8,
  },
  {
    id: "plan_enterprise",
    name: "Enterprise",
    badge: "CUSTOM WORKFORCE",
    priceMonthly: 3499,
    priceAnnual: 2999,
    isCurrent: false,
    features: [
      "Unlimited Monthly Ticket Ingress",
      "Custom Fine-Tuned AI Employee Models",
      "Enterprise SLA (15min FRT / 2hr Resolution)",
      "Dedicated PostgreSQL RLS Partition & Redis Cluster",
      "Keycloak SSO / SAML & Custom RBAC",
      "Custom Vertical Mesh & On-Premises Bridge",
      "24/7 Dedicated Support Engineer",
    ],
    slaCommitment: "99.99% SLA Attainment",
    computeUnits: "Unlimited Dedicated Compute",
    aiEmployeeSeats: 30,
  },
];
