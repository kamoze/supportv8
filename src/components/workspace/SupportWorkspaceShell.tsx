...
export const fullSupportNavigation: WorkspaceNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ask", label: "Ask supportV8", icon: MessageSquare },
      { id: "studio", label: "Autonomous Studio", icon: Cpu },
      { id: "workforce", label: "AI Workforce", icon: Users },
      { id: "voice", label: "Voice Telephony", icon: PhoneCall },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "stale_work", label: "Work Sweep", icon: Clock },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "market_workforce", label: "Active Capabilities", icon: Users },
