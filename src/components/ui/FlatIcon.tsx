...
export const Bell = createFlatIcon("fi-rr-bell", "Bell");
export const BellOff = createFlatIcon("fi-rr-bell-slash", "BellOff");
export const BookOpen = createFlatIcon("fi-rr-book-open-cover", "BookOpen");
export const Bot = createFlatIcon("fi-rr-robot", "Bot");
export const Box = createFlatIcon("fi-rr-box", "Box");
export const Package = createFlatIcon("fi-rr-box-alt", "Package");
...
export const VolumeX = createFlatIcon("fi-rr-volume-slash", "VolumeX");
